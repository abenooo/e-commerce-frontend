...
const Slide = ({img,title,mainTitle,price}) => {
  return (
    <div className="outline-none border-none relative">
      {/* sm:bg-transparent */}
      <div className="absolute left-[30px] md:left[70px] max-w-[250px] sm:max-w-[350px] top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4 bg-[#ffffffa2]  p-4 sm:p-0 rounded-lg sm:rounded-none">
