  ...
  return (
    <div className="min-h-[550px] flex justify-center items-center py-12">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl bg-blueBg">
          {/* first col */}
          ...
          <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
            ...
            <div data-aos="fade-up" data-aos-offset="0">
              <button
                className="bg-white py-2 px-4 rounded-full text-blueBg"
              >
                Shop Now
              </button>
            </div>
