          ...
          <div className={styles.parentWraper}>
            ...
            <div className={styles.firstDiv}>
              ...
              <ul role="list" className={styles.unorderList}>
                ...
                <li className={styles.footerLinks}>
                  <a href="#" title="Restaurants near me">
                    Restaurants near me
                  </a>
                </li>
                <li className={styles.footerLinks}>
                  <a href="#" title="Delivery near me">
                    Delivery near me
                  </a>
                </li>
                <li className={styles.footerLinks}>
                  <a href="#" title="Restaurants Open Now">
            ...
            <div className={styles.secondDiv}>
              ...
              <div className={styles.thirdDiv}>
                ...
                <ul role="list" className={styles.unorderList}>
                  <li className={styles.footerLinks}>
                    <a href="#" title="የኛ Shop for iOS">
                      የኛ Shop for iOS
                    </a>
                  </li>
                  <li className={styles.footerLinks}>
                    <a href="#" title="የኛ Shop for Android">
                      የኛ Shop for Android
                    </a>
                  </li>
                  <li className={styles.footerLinks}>
              ...
              <div className={styles.thirdDiv}>
                ...
                <ul role="list" className={styles.unorderList}>
                  <li className={styles.footerLinks}>
                    <a href="#" title="የኛ Shop.jp">
                      የኛ Shop.jp
                    </a>
                  </li>
                  <li className={styles.footerLinks}>
                    <a href="#" title="የኛ Shop.de">
                      የኛ Shop.de
                    </a>
                  </li>
                  <li className={styles.footerLinks}>
                    <a href="#" title="የኛ Shop.es">
                      የኛ Shop.es
                    </a>
                  </li>
                  <li className={styles.footerLinks}>
                    <a href="#" title="የኛ Shop.ca">
                      የኛ Shop.ca
                    </a>
                  </li>
                  <li className={styles.footerLinks}>
                    <a href="#" title="የኛ Shop.hk">
                      የኛ Shop.hk
                    </a>
                  </li>
                </ul>
              ...
              <div className={styles.thirdDiv}>
                ...
                <ul role="list" className={styles.unorderList}>
                  ...
                  <li className={styles.footerLinks}>
                    <div role="button" className="lowercases  font-bold">
                      Join us Now{" "}
                    </div>
                  </li>
            ...
            <div className={styles.largeButtonWraper}></div>
          </div>
          <div className={styles.copyrightsWraper}>
            <div className={styles.line}></div>
            <div className={styles.copyrighttextWraper}>
              <p className={styles.copyrighttext}>
                &copy; &nbsp; Copyright © 2023 የኛ Shop Ethiopia Ecommerce PTA
                Ltd Level 22, 150 Gambia Street, Addis Ababa - All rights
                reserved.
              </p>
              <p className={styles.copyrighttext}>ABN: 47 046 784 798</p>
            </div>
            <div className={styles.smallButtonWraper}></div>
          </div>
        </div>
      </div>
    </footer>
